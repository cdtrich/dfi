...
export function mapTotalCatGIFI(world, data, { width, height }) {
  ...
  const map = Plot.plot({
    ...
    subtitle: "five groups, 'pretty' breaks",
    // opacity: {
    //   legend: true,
    //   range: [0, 1],
    //   domain: [min, max],
    ...
    color: {
      legend: true,
      type: "ordinal",
      range: ["#962c8c", "#962c8c81", "#fffccc", "#32baa87f", "#32baa8"],
      //   range: ["#e63946", "#e8736181", "#fffccc", "#32baa87f", "#32baa8"],
